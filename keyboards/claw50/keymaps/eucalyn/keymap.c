...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //             (  )
  //,----+----+----+----+----+----+----.     ,----+----+----+----+----+----+----.
     BSLS,CIRC,PIPE,EXLM,AMPR,XXXX,XXXX,      XXXX,XXXX,EQL ,PLUS,ASTR,PERC,    ,
  //|----+----+----+----+----+----+----|     |----+----+----+----+----+----+----|
     GRV ,HASH,DLR ,DQT ,QUOT,TILD,LPRN,      RPRN,LEFT,DOWN, UP ,RGHT, AT ,    ,
  //|----+----+----+----+----+----+----|     |----+----+----+----+----+----+----|
     XXXX, 1  , 2  , 3  , 4  , 5  ,CMDL,      CMDR, 6  , 7  , 8  , 9  , 0  ,XXXX,
  //`----+----+----+----+----+----+----/     \----+----+----+----+----+----+----'
                        , HA ,BSPC,ENT ,         ,    ,    ,  
  //               `----+----+----+----'    `----+----+----+----'
  ),
