 ...
 * |------+------+------+------+------|           |------+------+------+------+------|
 * |  Ctrl|  Spc |  Sft |  Alt | Del  |           | BkSp | Home | End  | PgUp | PgDn |
 * `-------------+------+------+------|           |------+------+------+------+------'
 *               |      | LOWER|      |           |      | RAISE|      |
 *               `--------------------'           `--------------------'
 */
[_LOWER] = LAYOUT( \
  ...
  KC_LCTL, KC_SPC,  KC_LSFT, KC_LALT, KC_DEL,      KC_BSPC, KC_HOME, KC_END,  KC_PGUP, KC_PGDN, \
                    _______, _______, _______,      _______, _______, _______                    \
),
...
[_ADJUST] =  LAYOUT( \
  ...
  KC_F11,  KC_F12,  _______, KC_PSCR, KC_INS,       _______, _______, _______, _______, _______, \
