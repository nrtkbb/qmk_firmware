...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|----+----+----+----+----+----|              |----+----+----+----+----+----|
    S_ESC,S_A ,C_S ,A_D ,M_F , G  ,                H  ,M_J ,A_K ,C_L ,S_SC,S_ESC,
  //|----+----+----+----+----+----+              |----+----+----+----+----+----|
         , Z  , X  , C  , V  , B  ,                N  , M  ,COMM,DOT ,SLSH,    ,
  //`----+----+----+----+----+----/              \----+----+----+----+----+----'
                    LCMD,LOWER,C_ESC,   ,       ,S_SPC,RAISE,A_BS
  //               `----+-----+----+----'  `----+-----+-----+----'
  ), 
  ...
  //,----+----+----+----+----+----.              ,----+----+----+----+----+----.
         , 1  , 2  , 3  , 4  , 5  ,                6  , 7  , 8  , 9  , 0  ,    ,
  //|----+----+----+----+----+----|              |----+----+----+----+----+----|
         ,TAB ,    ,    ,    ,    ,               LEFT,DOWN, UP ,RGHT,ENT ,    ,
  //|----+----+----+----+----+----|              |----+----+----+----+----+----|
         ,LCTL,SPC ,LSFT,LALT,DEL ,               BSPC,HOME,END ,    ,    ,    ,
  //`----+----+----+--+-+----+----/              \----+----+----+----+----+----'
                        ,LOWER,    ,    ,       ,     ,RAISE,
  //               `----+-----+----+----'  `----+-----+-----+----'
  ),
