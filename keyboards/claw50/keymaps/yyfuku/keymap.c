...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //      
  //,----+----+----+----+----+----+----.     ,----+----+----+----+----+----+----.
    ,BSLS,CIRC,PIPE,EXLM,AMPR,XXXX,XXXX,      XXXX,AT  ,EQL ,PLUS,ASTR,PERC,    ,
  //|----+----+----+----+----+----+----|     |----+----+----+----+----+----+----|
     GRV ,HASH,DLR ,DQT ,QUOT,TILD,CMDL,      CMDR,LEFT,DOWN, UP ,RGHT,    ,    ,
  //|----+----+----+----+----+----+----|     |----+----+----+----+----+----+----|
    XXXX , 1  , 2  , 3  , 4  , 5  ,LPRN,      RPRN, 6  , 7  , 8  , 9  , 0  ,XXXX,
  //`----+----+----+----+----+----+----/     \----+----+----+----+----+----+----'
                        , HA ,BSPC,ENT ,         ,    ,    ,  
  //               `----+----+----+----'    `----+----+----+----'
  ),
